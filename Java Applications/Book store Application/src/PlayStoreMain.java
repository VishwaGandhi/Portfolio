public class PlayStoreMain 
{
        ...
        public static void main(String[] args) 
        {
                ...
                //There was a problem in the given code. had to replace r3 with r4 in the following line. Assumptions - ids can not be same 
                ...
                store.showContentByType(Game.class);
                ...
                store.showContentByType(Magazine.class);
